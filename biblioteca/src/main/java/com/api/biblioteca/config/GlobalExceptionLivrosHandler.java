...
public class GlobalExceptionLivrosHandler {
	...
	public ResponseEntity<ErroRespostaDto> handlerIsbnInexistente(IsbnInexistenteException ex, HttpServletRequest request){
		ErroRespostaDto erro = new ErroRespostaDto(
				ex.getMessage(), 
